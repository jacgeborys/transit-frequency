...
base_dir = r"C:\Users\Asus\OneDrive\Pulpit\Rozne\QGIS\TransitFrequency\_data\2024_03_27\WKD"
stops_file_path = os.path.join(base_dir, "stops_trip_count_WKD.shp")
output_file_path = os.path.join(base_dir, "isochrones", "WKD_isochrones.shp")
